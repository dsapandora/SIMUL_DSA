...
public class FicheroEscritura{
    ...
    /**
     * Mutodo que abre el fichero en modo escritura. Si no es posible, devuelve el valor 
     * booleano "false".
     * 
    ...
    /**
     * Mutodo que escribe un caructer en el fichero.
     * 
     * @param c El caructer a escribir en el fichero
    ...
    /**
     * Mutodo que escribe una cadena de caracteres.
     * 
    ...
    /**
     * Mutodo que escribe el caructer de fin de lunea.
     * 
     * @return "true" si se lleva a cabo la escritura sin problemas, "false" en caso contrario
     */
