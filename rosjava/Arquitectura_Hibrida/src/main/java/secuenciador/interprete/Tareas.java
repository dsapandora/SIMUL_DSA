...
public class Tareas {
	...
	/**
	 * Inicializa el conjunto o librerua de tareas del sistema, creando y rellenando dicho 
	 * librerua.
	 * 
	 * @param libreria Conjunto de todas las metas del sistema, con las que se crea una relaciun 
	...
	/**
	 * Devuelve una tarea concreta que forma parte de la librerua de tareas.
	 * 
	...
	/**
	 * Auade una tarea al conjunto de tareas
	 * 
	 * @param tarea La tarea a auadir al conjunto
	 * 
	 */
	...
	/**
	 * Elimina todas las tareas del conjunto, dejundolo vacuo para su posterior redefiniciun.
	 */
