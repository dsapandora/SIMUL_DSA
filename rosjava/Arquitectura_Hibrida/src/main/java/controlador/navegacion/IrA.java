 ...
 * 
 */
public class IrA extends Habilidad{

	/**
	 * Posicion dentro del mapa del mundo que se pretende alcanzar.
	 */
	...
	/**
	 * Inicializa la habilidad con el punto de destino deseado.
	 * 
	 ...
	 * 
	 * TODO Anadir otros parametros necesarios
	 * 
	 */
	public IrA(Robot robot, boolean sim){
		super("IrA", robot, sim);
		/* TODO Crear un punto de destino generico en funcion del tipo de mapa */
		this.destino = null;
               	this.izquierda = true;
		if(sim){
	...
	/**
	 * Devuelve el punto dentro del mapa del mundo destino de la habilidad.
	 * 
	...
	/**
	 * Asigna un nuevo punto de destino dentro del mapa del mundo que el robot debe alcanzar.
	 * 
	 * @param destino El nuevo punto destino del robot
	 * 
	 */
