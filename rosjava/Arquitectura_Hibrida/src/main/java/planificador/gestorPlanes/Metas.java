...
public class Metas {
	...
	/**
	 * Inicializa el conjunto o libreria de metas del sistema, creando y rellenando dicho 
	 * libreria.
	 */
	public Metas(){
	...
	/**
	 * Devuelve una meta concreta que forma parte de la libreria de metas.
	 * 
	...
	/**
	 * Anade una meta al conjunto de metas
	 * 
	 * @param meta La meta a anadir al conjunto
	 * 
	 */
	...
	/**
	 * Elimina todas las metas del conjunto, dejandolo vacio para su posterior redefinicion.
	 */
