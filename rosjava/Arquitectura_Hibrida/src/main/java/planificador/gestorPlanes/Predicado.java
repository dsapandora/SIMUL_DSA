...
/**
 * Clase que representa la parte minima del estado del modelo del mundo 
 * del concepto clasico de planificacion. Define una verdad en el modelo 
...
public class Predicado {
	...
	/**
	 * Identificador unico del predicado dentro del dominio del planificador.
	 */
	...
	/**
	 * Constructor por defecto para la libreria de metas, que no necesita de
	 ...
	 * @param pos La posicion del elemento dentro del array
	 */
