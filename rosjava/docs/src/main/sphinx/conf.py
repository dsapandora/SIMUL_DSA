# -*- coding: utf-8 -*-
#
# rosjava_core documentation build configuration file, created by
...
htmlhelp_basename = 'rosjava_coredoc'
...
latex_documents = [
  ('index', 'rosjava_core.tex', u'rosjava\\_core Documentation',
   u'damonkohler@google.com (Damon Kohler)', 'manual'),
]
