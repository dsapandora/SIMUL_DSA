...
static dWorldID gWorld = NULL;
static dSpaceID gSpace = NULL;


//-----------------------------------------------------------------
// Physics plug-in implementation

DLLEXPORT void webots_physics_init(dWorldID w,dSpaceID s,dJointGroupID j)
{
